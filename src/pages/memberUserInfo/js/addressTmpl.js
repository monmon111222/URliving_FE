...
<div>
    ...
    <div class="form-group">
        <input id="selectedAddressID" type="text" class="form-control full-border" :name="nameaddress" placeholder="地址"
...
<div>
    <div class="form-group">
        <input type="text" class="form-control full-border" :name="nameaddress" placeholder="Shipping Address" :value="userAddress"
            required>
    </div>
    <div v-if="nameaddress === 'recipientAddress' && selectedRegion !== '香港' && selectedRegion !== '澳門'"
        class="row with-small-gap">
        <div class="col">
            <div class="form-g">
                <input type="text" class="form-control full-border" name="recipientAddress2"
    ...
    <div v-if="selectedRegion !== '香港' && selectedRegion !== '澳門'" class="row with-small-gap">
        <div class="col">
            <div class="form-g">
