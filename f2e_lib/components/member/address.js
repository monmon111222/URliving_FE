...
const appAdress = {
	...
	data: {
		userAddress: {
			region: window.userRegion || "台灣及離島",
			county: window.userCounty || "臺北市",
			zipcode: window.userZipcode || "中正區",
			province: window.userProvince || "安徽",
		...
		shippingAddress: {
			...
			address: window.recipientAddress || "",
		},
