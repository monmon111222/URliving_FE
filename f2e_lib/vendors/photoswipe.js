...
var _items,
	...
	_initialContentSet,
	_initialZoomRunning,
	_controllerDefaultOptions = { //預設值
		index: 0,
		errorMsg: '<div class="pswp__error-msg"><a href="%url%" target="_blank">The image</a> could not be loaded.</div>', //預設找不到圖片怎麼辦
    videoTAG: '<video width="800" src="%url%" autoplay muted loop></video>',
...
var _getItemAt,
	...
	_checkForError = function(item, cleanUp) {
      ...
      if(item.type === 'video'){
        //如果是影片的話請用videoTAG
        item.container.innerHTML = _options.videoTAG.replace('%url%',  item.src );
      }else{
